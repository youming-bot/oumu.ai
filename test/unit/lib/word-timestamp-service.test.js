...
describe('Word Timestamp Service', () => {
  describe('generateWordTimestamps', () => {
    test('should generate timestamps for simple text', () => {
      ...
      // Act
      const timestamps = WordTimestampService.generateWordTimestamps(text, start, end);
    ...
    test('should handle empty text', () => {
      // Act
      const timestamps = WordTimestampService.generateWordTimestamps('', 0, 5);
    ...
    test('should handle text with multiple spaces', () => {
      ...
      // Act
      const timestamps = WordTimestampService.generateWordTimestamps(text, 0, 10);
    ...
    test('should ensure minimum word duration', () => {
      ...
      // Act
      const timestamps = WordTimestampService.generateWordTimestamps(text, 0, 0.5);
  ...
  describe('getCurrentWord', () => {
    ...
    test('should find current word at different times', () => {
      // Act & Assert
      expect(WordTimestampService.getCurrentWord(1, mockTimestamps)?.word).toBe('Hello');
      expect(WordTimestampService.getCurrentWord(2.1, mockTimestamps)?.word).toBe('world'); // Use 2.1 to avoid boundary
      expect(WordTimestampService.getCurrentWord(3, mockTimestamps)?.word).toBe('world');
      expect(WordTimestampService.getCurrentWord(5, mockTimestamps)?.word).toBe('test');
    });

    test('should return null for times outside timestamps', () => {
      // Act & Assert
      expect(WordTimestampService.getCurrentWord(-1, mockTimestamps)).toBeNull();
      expect(WordTimestampService.getCurrentWord(7, mockTimestamps)).toBeNull();
    });

    test('should return correct index', () => {
      // Act
      const result = WordTimestampService.getCurrentWord(3, mockTimestamps);
  ...
  describe('getWordContext', () => {
    ...
    test('should get context around current word', () => {
      // Act
      const context = WordTimestampService.getWordContext(1.2, mockTimestamps, 1);
    ...
    test('should handle beginning of array', () => {
      // Act
      const context = WordTimestampService.getWordContext(0.2, mockTimestamps, 2);
    ...
    test('should handle end of array', () => {
      // Act
      const context = WordTimestampService.getWordContext(2.4, mockTimestamps, 2);
    ...
    test('should return empty context when no current word', () => {
      // Act
      const context = WordTimestampService.getWordContext(10, mockTimestamps, 2);
  ...
  describe('calculateSpeakingRate', () => {
    test('should calculate words per minute correctly', () => {
      ...
      // Act
      const rate = WordTimestampService.calculateSpeakingRate(timestamps);
    ...
    test('should return 0 for insufficient data', () => {
      ...
      // Act & Assert
      expect(WordTimestampService.calculateSpeakingRate(singleWord)).toBe(0);
      expect(WordTimestampService.calculateSpeakingRate(noWords)).toBe(0);
    });
  });
  ...
  describe('findPauses', () => {
    test('should find pauses above threshold', () => {
      ...
      // Act
      const pauses = WordTimestampService.findPauses(timestamps, 0.3);
    ...
    test('should return empty array for no pauses', () => {
      ...
      // Act
      const pauses = WordTimestampService.findPauses(continuousTimestamps, 0.1);
  ...
  describe('smoothTimestamps', () => {
    test('should fix negative durations', () => {
      ...
      // Act
      const smoothed = WordTimestampService.smoothTimestamps(badTimestamps);
    ...
    test('should fix overlaps', () => {
      ...
      // Act
      const smoothed = WordTimestampService.smoothTimestamps(overlappingTimestamps);
    ...
    test('should handle empty array', () => {
      // Act
      const smoothed = WordTimestampService.smoothTimestamps([]);
  ...
  describe('toSRTFormat', () => {
    test('should convert timestamps to SRT format', () => {
      ...
      // Act
      const srt = WordTimestampService.toSRTFormat(timestamps);
    ...
    test('should handle empty array', () => {
      // Act
      const srt = WordTimestampService.toSRTFormat([]);
  ...
  describe('mergeWordTimestamps', () => {
    test('should merge timestamps from multiple segments', () => {
      ...
      // Act
      const merged = WordTimestampService.mergeWordTimestamps(segments);
  ...
  describe('exportToJSON', () => {
    test('should export timestamps to JSON format', () => {
      ...
      // Act
      const json = WordTimestampService.exportToJSON(timestamps);
    ...
    test('should handle empty array', () => {
      // Act
      const json = WordTimestampService.exportToJSON([]);
      const parsed = JSON.parse(json);
