import { AbLoopManager, formatTime, parseTime, SubtitleSynchronizer } from "@/lib/subtitle-sync";
...
describe("Subtitle Synchronization", () => {
  describe("SubtitleSynchronizer", () => {
    ...
    test("should get subtitle text at time", () => {
      // Arrange
      const segments = [createMockSegment(1, 0, 5, "Hello"), createMockSegment(2, 5, 10, "World")];
