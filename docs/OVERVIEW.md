...
### 核心价值
- **高质量转录**: 使用 Groq Whisper API 提供精确的语音识别
- **智能文本处理**: 通过 OpenRouter LLM 进行文本标准化和注释
...
### 数据流
```
音频上传 → 本地存储 → 分片处理 → Groq转录 → OpenRouter处理 → 字幕同步播放
```
